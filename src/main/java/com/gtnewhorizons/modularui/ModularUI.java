...
public class ModularUI {
    ...
    public static final String DEPENDENCIES = "required-after:CodeChickenLib@[1.1.5.7,);"
            + "required-after:gtnhmixins@[2.0.1,); " + "after:NotEnoughItems@[2.3.20-GTNH,);" + "before:gregtech";
