...
public class ListFluidHandler implements FluidHandler {
    ...
    public FluidStack insertFluid(int tank, Fluid fluid, long amount, boolean simulate) {
        ...
        Pair<? extends FluidHandler, Integer> result = findFluidHandler(tank);
        return result.getLeft().insertFluid(result.getRight(), fluid, amount, simulate);
    }
    ...
    public FluidStack extractFluid(int tank, long amount, boolean simulate) {
        ...
        Pair<? extends FluidHandler, Integer> result = findFluidHandler(tank);
        return result.getLeft().extractFluid(result.getRight(), amount, simulate);
    }
    ...
    public long getTankAmount(int tank) {
        ...
        Pair<? extends FluidHandler, Integer> result = findFluidHandler(tank);
        return result.getLeft().getTankAmount(result.getRight());
    }
