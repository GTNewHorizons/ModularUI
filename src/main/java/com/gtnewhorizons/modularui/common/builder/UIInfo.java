...
public class UIInfo<CC extends IContainerCreator, GC extends IGuiCreator> {
    ...
    /**
     * Open GUI of TileEntity at given position. This should be called only by logical server. For client-only GUI, use
     * {@link UIInfos#openClientUI(EntityPlayer, Function)}
     */
