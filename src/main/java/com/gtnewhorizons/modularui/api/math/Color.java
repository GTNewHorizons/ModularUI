...
public class Color implements Iterable<Integer> {
    ...
    /**
     * A helper method to apply a color to rendering. If the alpha is 0 and any other value is not null, the alpha will
     * be set to max.
     *
    ...
    public static final Color BLACK = new Color(
            0x000000,
            new int[] { 0x080808, 0x101010, 0x181818, 0x202020, 0x282828, 0x303030, 0x383838, 0x404040 });

    // from here on color values are taken from
    ...
    public static final Color DEEP_PURPLE = new Color(
            0x673AB7,
    ...
    public static final Color INDIGO = new Color(
            0x3F51B5,
    ...
    public static final Color TEAL = new Color(
            0x009688,
    ...
    public static final Color LIGHT_GREEN = new Color(
            0x8BC34A,
    ...
    public static final Color LIME = new Color(
            0xCDDC39,
    ...
    public static final Color DEEP_ORANGE = new Color(
            0xFF5722,
    ...
    public static final Color BROWN = new Color(
            0x795548,
    ...
    /**
     * @param index See actual instances for valid index
     */
