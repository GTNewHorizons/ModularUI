...
public class DynamicPositionedColumn extends Column implements ISyncedWidget {
    ...
    public DynamicPositionedColumn() {
    ...
    public DynamicPositionedColumn setSynced(boolean syncsToClient) {
