...
public class Color implements Iterable<Integer> {
    ...
    public static final Color WHITE = new Color(
            0xFFFFFF, new int[] {}, 0xF7F7F7, 0xEFEFEF, 0xE7E7E7, 0xDFDFDF, 0xD7D7D7, 0xCFCFCF, 0xC7C7C7, 0xBFBFBF);

    public static final Color BLACK = new Color(
            0x000000, new int[] {0x080808, 0x101010, 0x181818, 0x202020, 0x282828, 0x303030, 0x383838, 0x404040});
