...
/**
 * Wraps list of {@link IItemHandler} into one handler.
 */
@SuppressWarnings("unused")
public class ListItemHandler implements IItemHandlerModifiable {

    protected final Iterable<? extends IItemHandler> listItemHandler;

    public ListItemHandler(Iterable<? extends IItemHandler> listItemHandler) {
